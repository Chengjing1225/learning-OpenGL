...
int main() {
	...
	Shader shaderGeometryPass("5.9.g_buffer.vs", "5.9.g_buffer.fs");
	Shader shaderLightingPass("5.9.defferred_shading.vs", "5.9.defferred_shading.fs");
	Shader shaderLightBox("5.9.defferred_light_box.vs", "5.9.defferred_light_box.fs");

	Model nanosuit(getFullPath("img\\nanosuit\\nanosuit.obj").c_str());
	...
	if (glCheckFramebufferStatus(GL_FRAMEBUFFER) != GL_FRAMEBUFFER_COMPLETE)
	{
		...
		cout << "ERROR::l143:framebuffer::Framebuffer is not compele!" << endl;
	}
