...
Camera camera(glm::vec3(-1.0f, 5.0f, 5.0f));
...
int main()
{
	...
	// -------------------------
	Shader shadow("5.3.shadow.vs", "5.3.shadow.fs");
	Shader shadowMap("5.3.shadowTexture.vs", "5.3.shadowTexture.fs");
	Shader shadowDebug("5.3.shadowDebug.vs", "5.3.shadowDebug.fs");
	...
	// load textures
	// -------------
	unsigned int planeTexture = loadTexture(".//img//wood.png");
...
void processInput(GLFWwindow *window)
{
	...
	{
		cout << (blinn ? "Blinn-Phone" : "Phong") << endl;
		blinn = !blinn;
