...
void processInput(GLFWwindow *window)
{
	...
	{
		cout << "w" << deltaTime << endl;
		camera.ProcessMouseMovement(FORWARD, deltaTime);
	}
		
	if (glfwGetKey(window, GLFW_KEY_S) == GLFW_PRESS)
		camera.ProcessMouseMovement(BACKWARD, deltaTime);
	if (glfwGetKey(window, GLFW_KEY_A) == GLFW_PRESS)
		camera.ProcessMouseMovement(LEFT, deltaTime);
	if (glfwGetKey(window, GLFW_KEY_D) == GLFW_PRESS)
		camera.ProcessMouseMovement(RIGHT, deltaTime);
}
