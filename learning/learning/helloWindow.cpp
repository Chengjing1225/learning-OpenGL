...
int main()
{
	...
	// -------------------------
	Shader shader("5.4.shadowDebug.vs", "5.4.shadowDebug.fs");
	Shader simpleDepthShader("5.4.shadow.vs", "5.4.shadow.fs","5.4.shadow.gs");
	...
	const GLuint SHADOW_WIDTH = 800, SHADOW_HEIGHT = 800;
	GLuint depthMapFBO;
	glGenFramebuffers(1, &depthMapFBO);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		std::vector<glm::mat4> shadowTransforms;		//光空间变换矩阵
